...
from object_detection.meta_architectures import ssd_meta_arch_keras
...
from object_detection.models.ssd_antialiased_resnet_v1_fpn_feature_extractor import SSDAntResnet50V1FpnFeatureExtractor
...
SSD_FEATURE_EXTRACTOR_CLASS_MAP = {
    ...
    'ssd_resnet22_v1_fpn': ssd_resnet_v1_fpn.SSDResnet22V1FpnFeatureExtractor,
    ...
    'ssd_ant_resnet50_v1_fpn': SSDAntResnet50V1FpnFeatureExtractor,
...
def _build_ssd_feature_extractor(feature_extractor_config,
  ...
  use_antialias = feature_extractor_config.use_antialias
  # parameters only for student net
  if "ssd_mobilenet_v3" in feature_type:
    network_version = feature_extractor_config.network_version
    min_feature_level = feature_extractor_config.min_feature_level
    max_feature_level = feature_extractor_config.max_feature_level
    additional_layer_depth = feature_extractor_config.additional_layer_depth
  ...
  if "ssd_mobilenet_v3" in feature_type:
    kwargs.update({'network_version': network_version,
...
def _build_ssd_model(ssd_config, is_training, add_summaries):
  ...
  kwargs.update({"feature_extractor": feature_extractor})
