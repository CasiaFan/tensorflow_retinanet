...
from object_detection import coco_tools
from object_detection import json_utils
...
class CocoDetectionEvaluator(DetectionEvaluator):
  ...
  def add_single_ground_truth_image_info(self,
    ...
    groundtruth_is_crowd = groundtruth_dict.get("groundtruth_is_crowd")
  ...
  def get_estimator_eval_metric_ops(self, eval_dict):
    ...
    groundtruth_is_crowd = eval_dict.get("groundtruth_is_crowd", None)
...
# category_index = create_categories_from_labelmap("../data/label.pbtxt")
